...
0000000000400f43 <phase_3>:
  ...
  400f60:	83 f8 01             	cmp    $0x1,%eax            /* Number of input > 1 */
  400f63:	7f 05                	jg     400f6a <phase_3+0x27>
  400f65:	e8 d0 04 00 00       	callq  40143a <explode_bomb>
  400f6a:	83 7c 24 08 07       	cmpl   $0x7,0x8(%rsp)       /* 3rd input < 7 */
  400f6f:	77 3c                	ja     400fad <phase_3+0x6a>    
  400f71:	8b 44 24 08          	mov    0x8(%rsp),%eax
  400f75:	ff 24 c5 70 24 40 00 	jmpq   *0x402470(,%rax,8)   /* rax==1 -> jump to 400fb9 */
  ...
  400fbe:	3b 44 24 0c          	cmp    0xc(%rsp),%eax       /* Compare 4th input with eax */
...
000000000040100c <phase_4>:
  ...
  401029:	83 f8 02             	cmp    $0x2,%eax            /* argc == 2 */
